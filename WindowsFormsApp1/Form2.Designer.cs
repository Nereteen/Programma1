namespace WindowsFormsApp1
{
	partial class Form2
	{
		...
		private void InitializeComponent()
		{
			...
			this.button6.Text = "Вычислить коэффициент";
			...
			this.button7.Text = "Вычислить коэффициент";
			...
			this.button8.Text = "Вычислить коэффициент";
			...
			this.button9.Text = "Вычислить коэффициент";
			...
			this.button10.Text = "Вычислить коэффициент";
			...
			this.groupBox2.Text = "Показания датчика ";
			// 
			// groupBox3
			// 
			...
			this.groupBox4.Text = "Показания датчика принятые за ноль";
			// 
			// textBox6
			// 
			this.textBox6.Location = new System.Drawing.Point(12, 86);
			...
			// textBox9
			// 
			this.textBox9.Location = new System.Drawing.Point(12, 176);
